...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return iniciarBitcoinFetch; });\nfunction iniciarBitcoinFetch() {\n    fetch('https://blockchain.info/ticker')\n    .then((resposta) => resposta.json())\n    .then((bitcoin) => {\n        const btcPreco = document.querySelector(\".btc-preco\");\n        const precoDoacao = (1000 / bitcoin.BRL.sell).toFixed(4);\n        btcPreco.innerText = String(precoDoacao).replace(\".\", \",\");\n    }).catch((erro) => {\n        console.log(erro);\n    });\n}\n\n\n//# sourceURL=webpack:///./js/modules/bitcoin-fetch.js?");
